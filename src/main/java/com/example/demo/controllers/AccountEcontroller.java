...
@Controller
public class AccountEcontroller {
...
/*
  @RequestMapping("/Addaccountc") public String Addnewaccount(Model model) {
  ...
  @PostMapping("/saveaccountc") public String saveaccountc(@ModelAttribute
  CompteC accountc , Model model) { ac.save(accountc); return
  "redirect:/Addaccountc"; }
  
  @GetMapping("/deleteac/{Code}") public String deleteclient(@PathVariable Long
  Code) { ac.deleteById(Code); return "redirect:/home"; }
